...
{
 switch($tri) {
  case "name" : $var['order']=" ORDER BY competition_name ".$sens." "; break;
  default : $var['order']=" ORDER BY competition_name ".$sens." ";
 }
}
...
$sql_competition=sql_replace($sql['competition']['select_competition_condition'],$var);
