...
?>
	    <?php _e('Title:'); ?> <input style="width: 450px;" id="bfa_pp_src-title" name="bfa_pp_src-title" type="text" value="<?php echo $bfa_pp_title; ?>" />
            <hr noshade size="1" style="clear:left; color: #ccc">
            <p style="text-align: left;"><?php _e('Show'); ?> <input style="width: 20px;" id="bfa_pp_no_posts" name="bfa_pp_no_posts" type="text" value="<?php echo $bfa_pp_no_posts; ?>" /> 
            <?php _e('posts not older than'); ?> <input style="width: 40px;" id="bfa_pp_duration" name="bfa_pp_duration" type="text" value="<?php echo $bfa_pp_duration; ?>" /> <?php _e('days and with at least'); ?>&nbsp;
   	    <input style="width: 20px;" id="bfa_pp_min_amount_comments" name="bfa_pp_min_amount_comments" type="text" value="<?php echo $bfa_pp_min_amount_comments; ?>" /> <?php _e('comment(s)'); ?>
   	    </p>
  	    <hr noshade size="1" style="clear:left; color: #ccc">
            <p><?php _e('And display the list on:'); ?> </p>
