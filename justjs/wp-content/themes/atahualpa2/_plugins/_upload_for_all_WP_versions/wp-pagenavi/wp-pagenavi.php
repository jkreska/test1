...
# NOTE BY BYTESFORALL: CSS already included in the theme's main CSS file to save 1 hit to the server.
...
function pagenavi_init() {
	...
	$pagenavi_options['next_text'] = __('Next &raquo;','wp-pagenavi');
	$pagenavi_options['prev_text'] = __('&laquo; Previous','wp-pagenavi');
