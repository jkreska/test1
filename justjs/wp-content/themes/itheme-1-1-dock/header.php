...
<!--dock menu -->
<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/dock/dock.css" type="text/css" media="all" />
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/dock/jquery.js"></script>
<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/dock/interface.js"></script>
...
<style type="text/css">
	#dock img { behavior: url(<?php bloginfo('stylesheet_directory'); ?>/dock/iepngfix.htc) }
</style>
<![endif]-->
