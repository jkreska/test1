...
// Use WordPress' own paging config?
// ------------
// As of WP 2.7, comment paging is a builtin in feature. 
// If you'd still like to use this plugin, this option allows you to use
// the paging configuration specified in Discussion Settings
// (under 'Other comment settings') to override some of the values in
// this config file.
